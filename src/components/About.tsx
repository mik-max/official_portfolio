...
export function About() {
  return (
    <section id="about" className="relative py-20 sm:py-28 border-t border-ink/10 bg-paper">
      <div className="section-content max-w-[1400px] mx-auto px-6 lg:px-20">
        <div className="grid lg:grid-cols-12 gap-12 lg:gap-16 items-center">
          <div className="lg:col-span-7 space-y-6 sm:space-y-8 order-2 lg:order-1">
            ...
            <h2 className="about-title font-display text-4xl sm:text-5xl lg:text-6xl font-normal leading-tight perspective-[1000px]">Hi, I&apos;m Michael.</h2>
          ...
          <div className="lg:col-span-5 relative order-1 lg:order-2 group">
            <div className="aspect-[4/5] sm:aspect-[1/1] lg:aspect-[4/5] relative rounded-3xl overflow-hidden border border-ink/10 shadow-xl max-w-md mx-auto lg:max-w-none transition-transform duration-500 group-hover:scale-[1.02]">
              <Image
