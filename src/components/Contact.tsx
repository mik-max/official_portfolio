    ...
    <section id="contact" className="relative py-20 sm:py-28 lg:py-40 border-t border-ink/10 bg-paper">
      <div className="section-content max-w-[1400px] mx-auto px-6 lg:px-20">
        <div className="max-w-3xl mx-auto text-center">
          ...
          <h2 className="contact-heading font-display text-5xl sm:text-6xl lg:text-7xl font-normal leading-[1.05] mb-10 perspective-[1000px]">Let&apos;s build something <em className="italic text-accent">exceptional.</em></h2>
