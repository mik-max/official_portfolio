    ...
    <section id="contact" className="relative py-20 sm:py-28 lg:py-40 bg-paper-raised">
      ...
      <div className="section-content relative max-w-[1400px] mx-auto px-6 lg:px-20">
        <div className="max-w-3xl mx-auto text-center">
          ...
          <h2 className="contact-heading font-display text-4xl sm:text-6xl lg:text-7xl font-bold leading-[1.05] mb-10">Let&apos;s build something <span className="text-accent">exceptional.</span></h2>
