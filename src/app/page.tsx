    ...
    <main className="bg-black text-white min-h-screen overflow-x-hidden font-sans selection:bg-white selection:text-black">
      ...
      <nav className="fixed top-4 sm:top-6 left-0 right-0 z-[100] px-4 md:px-6 max-w-[1400px] mx-auto w-full flex items-center justify-between">
        <div className="flex items-center gap-3">
          <div className="w-8 h-8 sm:w-9 sm:h-9 rounded-full bg-gradient-to-br from-blue-500 to-emerald-600 flex items-center justify-center font-bold text-white shadow-[0_0_15px_rgba(59,130,246,0.3)]">
            M
          </div>
      ...
      {/* Hero Section */}
      <section ref={heroRef} id="home" className="relative z-20 min-h-[100dvh] flex flex-col justify-center px-6 lg:px-20 max-w-[1400px] mx-auto pt-24 pb-48 sm:pb-32">
        <div className="max-w-4xl space-y-6 sm:space-y-8 relative z-20">
          ...
          <h1 className="hero-title text-4xl sm:text-7xl lg:text-[5.5rem] leading-[1.1] sm:leading-[1.05] tracking-tight font-bold">
          ...
          <div className="hero-cta flex flex-wrap gap-4 sm:gap-5 pt-2 sm:pt-4">
            <a href="#projects" className="px-6 py-3.5 sm:px-8 sm:py-4 bg-white text-black text-sm sm:text-base font-medium rounded-full flex items-center gap-3 hover:scale-105 transition-transform">
              View My Work ↗
            </a>
            <a href="/resume.pdf" download className="px-6 py-3.5 sm:px-8 sm:py-4 bg-white/5 backdrop-blur-md border border-white/20 hover:bg-white/10 text-white text-sm sm:text-base font-medium rounded-full flex items-center gap-3 transition-colors">
              Download CV ↓
            </a>
          </div>
        </div>

        {/* Hero Bottom Info - Optimized spacing for tablet & mobile */}
      ...
      {/* About Section */}
      <section id="about" className="relative py-20 sm:py-28 border-t border-white/10">
        <div className="max-w-[1400px] mx-auto px-6 lg:px-20">
          <div className="grid lg:grid-cols-12 gap-12 lg:gap-16 items-center">
            <div className="lg:col-span-7 space-y-6 sm:space-y-8 order-2 lg:order-1">
              ...
              <h2 className="text-4xl sm:text-5xl lg:text-6xl font-bold tracking-tight leading-tight">Hi, I’m Michael.</h2>
            ...
            <div className="lg:col-span-5 relative order-1 lg:order-2">
              <div className="aspect-[4/5] sm:aspect-[1/1] lg:aspect-[4/5] relative rounded-3xl overflow-hidden border border-white/10 shadow-2xl max-w-md mx-auto lg:max-w-none">
                <Image src="/images/about-photo.jpg" alt="Michael Chinye" fill className="object-cover" quality={100} sizes="(max-width: 1024px) 100vw, 40vw" />
      ...
      {/* Skills Section */}
      <section id="skills" className="relative py-20 sm:py-28 border-t border-white/10 bg-black">
        <div className="max-w-[1400px] mx-auto px-6 lg:px-20">
            ...
            <div className="group">
              ...
              <div className="flex flex-wrap gap-2.5 sm:gap-3">
                {['React.js', 'Next.js', 'TypeScript', 'JavaScript', 'Tailwind CSS', 'GSAP', 'HTML5', 'CSS3'].map((skill) => (
                  <div key={skill} className="px-4 py-2 sm:px-6 sm:py-3 bg-white/5 hover:bg-white/10 border border-white/10 hover:border-white/30 rounded-full text-white/80 text-xs sm:text-sm font-medium transition-all">{skill}</div>
                ))}
              </div>
            </div>
            <div className="group">
      ...
      {/* Experience Section */}
      <section id="experience" className="relative py-20 sm:py-28 border-t border-white/10 bg-black">
        <div className="max-w-[1400px] mx-auto px-6 lg:px-20">
                ...
                <div className="flex-1">
                  <div className="bg-white/5 border border-white/10 rounded-3xl p-8 lg:p-10 hover:border-white/30 transition-all hover:translate-x-1 shadow-xl">
                    ...
                    <ul className="space-y-4 text-white/70 text-base sm:text-lg leading-relaxed">
                      ...
                      <li className="flex gap-4"><span className="text-white/30 mt-1.5 flex-shrink-0 text-xs挑战">02</span><span>Developed logistics web application connecting transporters and clients.</span></li>
      ...
      {/* Projects Section */}
      <section id="projects" className="relative py-20 sm:py-28 border-t border-white/10 bg-black">
        <div className="max-w-[1400px] mx-auto px-6 lg:px-20">
          <div className="flex items-center gap-3 mb-16">
            <span className="w-8 h-px bg-white/40"></span>
      ...
      {/* Contact Section */}
      <section id="contact" className="relative py-20 sm:py-28 lg:py-40 border-t border-white/10 bg-black">
        <div className="max-w-[1400px] mx-auto px-6 lg:px-20">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <div className="bg-white/5 border border-white/10 rounded-[2.5rem] p-6 sm:p-10 lg:p-12 mx-auto max-w-2xl shadow-2xl">
              <div className="space-y-6 sm:space-y-8">
                <a href="mailto:michaelchinye2018@gmail.com" className="block group">
        ...
        <div className="max-w-[1400px] mx-auto px-6 lg:px-20 flex flex-col md:flex-row justify-between items-center gap-12 text-sm">
          ...
          <div className="flex flex-wrap justify-center items-center gap-6 sm:gap-10 text-white/40 uppercase tracking-[2px] font-bold text-[10px]">
            {navItems.filter(i => i.id !== 'home').map(item => (
              <a key={item.id} href={item.href} className="hover:text-white transition-colors">{item.label}</a>
            ))}
          </div>
          <a href="https://linkedin.com/in/chinyemichael" target="_blank" className="flex items-center gap-2 text-white/40 hover:text-white transition-all font-bold tracking-widest uppercase text-xs">
